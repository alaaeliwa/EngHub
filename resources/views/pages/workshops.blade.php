                    ...
                    <div class="featured-card">
                        ...
                        <div class="featured-content">
                            ...
                            <div class="workshop-meta">
                                <span><i class="fa-solid fa-calendar"></i> {{ \Carbon\Carbon::parse($featuredWorkshop->date)->format('M d, Y') }}</span>
                                <span><i class="fa-solid fa-clock"></i> {{ \Carbon\Carbon::parse($featuredWorkshop->time)->format('h:i A') }}</span>
                                <span><i class="fa-solid fa-location-dot"></i> {{ $featuredWorkshop->location ?? __('messages.ws_type_online') }}</span>
                            </div>
                            <div class="featured-footer">
                                <span class="seats-left"><i class="fa-solid fa-users"></i> {{ max(0, $featuredWorkshop->capacity - $featuredWorkshop->registered) }} {{ __('messages.ws_seats_left') }}</span>
                                <a href="{{ route('workshop-details', ['id' => $featuredWorkshop->id]) }}" class="btn btn-outline sm">{{ __('messages.ws_details_reg') }}</a>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="workshops-grid">
                        ...
                        <div class="workshop-main-card">
                            ...
                            <div class="card-content">
                                ...
                                <p class="instructor">{{ __('messages.ws_location') }}: {{ $workshop->location }}</p>
                                <div class="card-meta">
                                    <span><i class="fa-solid fa-calendar"></i> {{ $workshop->date }}</span>
                                </div>
                                <div class="card-footer">
                                    <span class="status"><i class="fa-solid fa-users"></i> {{ $workshop->registered }} {{ __('messages.ws_registered') }}</span>
                                    <a href="{{ route('workshop-details', $workshop->id) }}" class="btn btn-outline sm">{{ __('messages.ws_register') }}</a>
                                </div>
                            </div>
                        </div>
                        @empty
